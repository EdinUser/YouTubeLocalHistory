...
let pendingFeedDiscovery = ytvhtFeedContracts.createPendingFeedDiscovery({ videoIds: [], discoveredAt: 0 });
let newlyShownFeedVideoIds = [];
let pendingFeedNoticeState = { busy: false, error: '' };
